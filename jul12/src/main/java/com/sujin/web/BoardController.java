 ...
 * 		해당 중복 작업을 기준으로 동일 행동을 하게 만드는 것이다.
 * 		메소드가 실행되기전, 실행된 직후, 실행시점에 따라 따로 기능을 적용 시키는 것이다.
 * 
 */
@Controller
public class BoardController {
	...
	// @RequestMapping(value = "/board", method = RequestGet...)를 아래로 줄임
	@GetMapping("/board")
